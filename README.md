...
Сделаны этапы 1–3: фундамент, библиотека и ход агента. Бот отвечает на
входящие после дебаунса, ведёт лида до диагностики и дальше по касаниям; в
чате видно режим и этап, что бот понял и что «отправил бы» (в сухом прогоне),
ходы можно оценивать, а плейбуки — проверять в песочнице. Черновики для
менеджера с кнопками и статистика — следующие этапы.
