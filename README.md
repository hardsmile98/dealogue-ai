...
(в сухом прогоне), ходы можно оценивать, а весь сценарий — прогнать в песочнице:
там диалог с выдуманным клиентом ведётся от первого сообщения до напоминаний, и
тишину между касаниями можно промотать на любое число часов.
