...
Сделаны этапы 1–5: фундамент, библиотека, ход агента, касания и работа
менеджера. Бот отвечает на входящие после дебаунса, ведёт лида до диагностики
и дальше по касаниям до напоминаний; в чате видно режим и этап, что бот понял
и что «отправил бы» (в сухом прогоне), ходы можно оценивать, а плейбуки —
проверять в песочнице. Когда нужен человек, в чате появляется черновик ответа
с кнопками «отправить как есть / с правками / свой ответ / не отвечать»,
все такие чаты собираются в разделе «Требуют внимания», а в Telegram аккаунта
приходит короткое уведомление со ссылкой. Обучение на оценках и статистика —
следующие этапы.
